...
export default function NotificationItem({ notification, onMarkRead, onClose }: Props) {
  ...
  return (
    <div
      ...
      aria-label={isUnread ? `${notification.title}. Marcar como leída` : notification.title}
    >
      ...
      <div className={styles.itemContent}>
        <div className={styles.itemTitleRow}>
          ...
          {isUnread && <span className={styles.unreadDot} aria-label="Sin leer" />}
        </div>

        <p className={styles.itemMessage} title={notification.message}>
          {notification.message}
        </p>

        <div className={styles.itemMeta}>
          <span className={styles.itemBadges}>
            <span className={`${styles.typeChip} ${iconClass[notification.type] ?? styles.iconSystem}`}>
              {typeLabel[notification.type] ?? 'Aviso'}
            </span>
            <time
